...
from app.api.admin import calendar as admin_calendar
from app.api.admin import pricing as admin_pricing
from app.api.admin import properties as admin_properties
from app.api.public import bookings, calendar, properties
